...
const WhatsAppWidget = () => {
  ...
  return (
    <>
      ...
      {/* Chat Popup */}
      {isOpen && (
        <div className="fixed z-50 p-4 transition-all duration-300 bg-white shadow-xl w-72 bottom-20 right-5 rounded-xl animate-fade-in">
          <h3 className="mb-2 text-lg font-semibold">Chat with Ranjeet 💬</h3>
          <p className="mb-4 text-sm text-gray-600">
            Hello! 👋 <br />
            Have questions or collaboration ideas? Let’s connect on WhatsApp.
          </p>
          <a
