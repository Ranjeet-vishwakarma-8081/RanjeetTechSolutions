const MagicButton = ({ title, icon, position, handleClick, disabled }) => {
  return (
    <button
      className="relative inline-flex w-full h-12 overflow-hidden rounded-lg p-[1px] focus:outline-none md:w-60"
      onClick={handleClick}
      disabled={disabled}
    >
